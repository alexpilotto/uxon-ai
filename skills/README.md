...
- [Branding](branding.md): inspect branding readiness and adjust color variables, brand colors, logo URLs, font variables, custom font URL imports, palette name, and brand voice.
